...
from NaoRobot.pyrogramee.telethonbasics import is_admin
...
__help__ = """
<b> Group Guardian: </b>
✪ RogerexRobot can protect your group from NSFW senders, Slag word users and also can force members to use English
